...
sed -i.bk "s|xxxxxx\.yyyyyy\.zzzzzz|\${packageName}|g" target/classes/archetype-resources/pom.xml
...
sed -i.bk "s|xxxxxx\.yyyyyy\.zzzzzz|\${packageName}|g" src/main/resources/archetype-resources/src/main/resources/META-INF/native-image/__package__/__artifactId__/app.json
